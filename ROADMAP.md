...
### 9.2 Действия естественным языком + резолв цели по смыслу
- [ ] Расширить AI-интент на `DONE/SNOOZE/FORGET/EDIT/REMIND/LIST` + извлечение описания цели и параметров. Резолв цели семантически (эмбеддинги/совпадение) вместо номера: «закрой задачу про покупку стула» → нужная задача.

### 9.3 Подтверждение и уточнение (мини-диалог)
- [ ] Per-chat «ожидающее действие»: уверенно одна цель → действуем (или «да/нет» для забывания/правки); несколько → «какую?»; не нашли → «уточни».
